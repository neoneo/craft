...
component extends="mxunit.framework.TestCase" {
	...
	public void function setUp() {
		variables.placeholder1 = mock(CreateObject("Placeholder")).getRef().returns("p1")
		variables.placeholder2 = mock(CreateObject("Placeholder")).getRef().returns("p2")
		variables.placeholder3 = mock(CreateObject("Placeholder")).getRef().returns("p3")
		variables.placeholder4 = mock(CreateObject("Placeholder")).getRef().returns("p4")
		variables.placeholder5 = mock(CreateObject("Placeholder")).getRef().returns("p5")
		variables.placeholder6 = mock(CreateObject("Placeholder")).getRef().returns("p6")

		var template = mock(CreateObject("Template")).getPlaceholders().returns([placeholder1, placeholder2])
		variables.document = new DocumentTemplate(template)
	}

	public void function GetPlaceholders_Should_ReturnTemplatePlaceholders() {
		var placeholders = variables.document.getPlaceholders()
		...
		var section2 = mock(CreateObject("Section")).getPlaceholders().returns([placeholder3, placeholder4])
		variables.document.addSection(section2, variables.placeholder2)
	...
	public void function GetPlaceholders_Should_ReturnPlaceholdersRecursively() {
		// Fill placeholder2.
		var section2 = mock(CreateObject("Section")).getPlaceholders().returns([variables.placeholder3])
		variables.document.addSection(section2, variables.placeholder2) // This now contains p1 (from the parent template) and p3.
		...
		document2.addSection(section1, variables.placeholder1)
		var placeholders = document2.getPlaceholders()
		...
		var section3 = mock(CreateObject("Section")).getPlaceholders().returns([variables.placeholder4])
		document2.addSection(section3, variables.placeholder3)
		var placeholders = document2.getPlaceholders()
		...
		var section4 = mock(CreateObject("Section")).getPlaceholders().returns([variables.placeholder5, variables.placeholder6])
		document3.addSection(section4, variables.placeholder4)
		var placeholders = document3.getPlaceholders()
