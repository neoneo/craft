...
component extends="mxunit.framework.TestCase" {
	...
	public void function setUp() {
		variables.root = new PathSegment()
		variables.parser = new RoutesParser(variables.root, new PathSegmentFactory(), new CommandFactoryStub())
	}
	...
	public void function RootRoute() {
		...
		assertSame(variables.root, pathSegment)
