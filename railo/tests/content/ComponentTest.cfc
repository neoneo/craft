component extends="mxunit.framework.TestCase" {
	...
	public void function Render_WithoutChildren_Should_ReturnOwnContent() {
		var result = variables.component.render(variables.context)
		assertEquals("before  after", result, "render() without children should return content without [[children]] placeholder")
	}
